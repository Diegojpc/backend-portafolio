export const es = {
  ...
  about: {
    ...
    text1: "¡Hola! Soy Diego, un Ingeniero en IA y Científico de Datos impulsado por mi pasión por la tecnología y la optimización. Con una base sólida en Ingeniería Acústica, logro cerrar la brecha entre dominios matemáticos complejos y soluciones de IA prácticas y de alto impacto.",
    text2: "Me especializo en el desarrollo integral de sistemas de IA, desde la creación de modelos predictivos con <strong>Scikit-learn</strong> y <strong>TensorFlow</strong> hasta la construcción de APIs robustas con <strong>FastAPI</strong>. Mi trabajo reciente se ha centrado en la frontera de la IA generativa, donde he implementado <strong>sistemas RAG con LangChain</strong> y diseñado asistentes de voz conversacionales para mejorar la interacción del usuario. Me dedico a utilizar los datos no solo para analizar, sino para construir herramientas inteligentes que brinden resultados reales."
  },
  contact: {
